...
},
{
  ...
  name: "Dr. Anil Kumar, Professor & HoD CSE Department, PIET",
...
},
{
  ...
  nominatedBy: "Principal (Seniority Rotation)",
  category: "Teachers of the College",
  name: "Dr. Budesh Kanwar, Professor & HoD AI&DS Department, PIET",
...
},
{
  ...
  name: "Prof. (Dr.) D. K. Palwalia, Dean Academics, RTU Kota",
  email: "dkpalwalia@rtu.ac.in / dean.academic@rtu.ac.in",
},
{
  sno: 11,
  position: "Institution Representative-1",
  nominatedBy: "Shanti Education Society",
  category: "Institution Representative",
  name: "Mrs. Dipti Lodha, Director (Alumni & Corporate Relations), Poornima Group",
  email: "diptilodha@poornima.org",
},
{
  sno: 12,
  position: "Institution Representative-2",
  nominatedBy: "Shanti Education Society",
  category: "Institution Representative",
  name: "Mr. Ashwini Lata, Director, Student Welfare, Poornima Group",
  email: "dsw@poornima.org",
},
{
  sno: 13,
  position: "Institution Representative-3",
  nominatedBy: "Shanti Education Society",
  category: "Institution Representative",
...
{
  sno: 14,
  position: "Institution Representative-4",
  nominatedBy: "Principal",
  category: "Institution Representative",
  name: "Dr. Amit Shrivastava, Professor, Controller of Examinations, PIET",
  email: "coe.piet@poornima.org",
},
{
  sno: 15,
  position: "Institution Representative-5",
  nominatedBy: "Principal",
  category: "Institution Representative",
...
{
  sno: 16,
  position: "Institution Representative-6",
  nominatedBy: "Principal",
  category: "Institution Representative",
  name: "Dr. Sama Jain, Professor, HoD AS Department, PIET",
  email: "sama.jain@poornima.org",
},
{
  sno: 17,
  position: "Institution Representative-7",
  nominatedBy: "Principal",
  category: "Institution Representative",
  name: "Dr. Payal Bansal, Professor, HoD IoT Department, PIET",
  email: "payal.bansal@poornima.org",
},
{
  sno: 18,
  position: "Institution Representative-8",
  nominatedBy: "Principal",
  category: "Institution Representative",
...
{
  sno: 19,
  position: "Alumni/Industry Expert CS-IT",
  nominatedBy: "Principal",
...
{
  sno: 20,
  position: "Alumni/Industry Expert Emerging Tech",
  nominatedBy: "Principal",
...
{
  sno: 21,
  position: "Alumni/Industry Expert ECE/EE",
  nominatedBy: "Principal",
...
{
  sno: 22,
  position: "Alumni/Industry Expert HR",
  nominatedBy: "Principal",
  category: "Alumni/Industry Expert of HR",
  name: "Mr. Manoj Pipersania, CEO, Softserv",
  email: "manoj@softserv.in",
},
{
  sno: 23,
  position: "Principal of College (Member Secretary)",
