...
import CurriculumInnovation from "@/components/autonomous/CurriculumInnovation";
...
const AutonomousPage: React.FC = () => {
  ...
  const [syllabusView, setSyllabusView] = React.useState<{
    degree: string;
    branch: string;
}>({
    degree: "",
...
const exploreOpenElectives = () => {
    setSyllabusView({
        degree: "Open Elective",
        branch: "",
    });
  ...
  return (
    ...
    onExploreMinor={exploreMinorDegrees}
    onExploreOpenElectives={exploreOpenElectives}
/>
          </div>
        )}
