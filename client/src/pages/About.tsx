...
const About = () => {
    ...
    const highlights = [
        ...
        },
        {
            ...
            description:
                "IQAC-driven academic excellence through audits, reviews, monitoring, and Outcome Based Education practices.",
        },
        {
    ...
    return (
       <div className="min-h-screen bg-neutral-50">
         <AccessibilityFeatures />
            ...
            <BreadCrumb
                title="About Us"
                description="Discover the legacy, innovation, and excellence that
...
<div className="container mx-auto px-4 lg:px-0 -mt-6 relative z-20 mb-20"> {/* Reduced negative margin */}
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-secondary">
                                <p className="text-neutral-700 leading-relaxed">
                                    ...
                                    minor certificates, capstone projects,internship and honors.
                                </p>
                            </div>
                            ...
                            <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-primary">
                                <p className="text-neutral-700 leading-relaxed">
                                    ...
                                    through audits, reviews, monitoring and Outcome Based
