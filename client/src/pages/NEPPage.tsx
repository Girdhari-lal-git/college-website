...
const iksHighlights = [
    "The Indian Knowledge System (IKS) represents a vast and intricate repository of intellectual heritage, meticulously documented in languages such as Sanskrit, Pali, Prakrit, and numerous other native Indian tongues. Its scope is encyclopedic, offering a structured classification of knowledge that spans foundational philosophies, advanced sciences, engineering, technology, the humanities, and social sciences. This system is not a disjointed collection but a coherent body of interlinked disciplines.",
    "Among its many prolific branches are Astronomy, which charted planetary motions with remarkable accuracy; Ayurveda & Yoga, which offer holistic frameworks for health and well-being; and Mathematics, which gifted the world the concept of zero and foundational algorithms. The sophistication of this system was historically encapsulated in the curriculum of the eighteen Vidya Sthanas (centers of learning), which provided a comprehensive and interdisciplinary education.",
    "In today's globalized world, this deep and diverse knowledge base is not merely an academic relic; it is a crucial asset for knowledge diplomacy. By sharing its timeless principles and proven solutions, IKS allows India to engage with the world on a unique intellectual platform, fostering cross-cultural dialogue and offering sustainable alternatives to contemporary global challenges.",
    
];

const nepCommittee2024 = [
    { name: "Dr.Dinesh Goyal", designation: "Chairman" },
    { name: "Dr. Krati Sharma", designation: "Faculty Coordinator" },
  ...
  return (
    <div>
      ...
      <BreadCrumb
        ...
        description="Details on the implementation of NEP 2020 at Poornima Institute of Engineering & Technology."
        breadcrumbs={[
          { label: "Home", href: "/" },
          { label: "NEP 2020", isCurrent: true },
        ]}
      />
      ...
      <OverviewSection
        title="Overview"
        subtitle="Implementation of NEP 2020 at PIET"
        reverse={false}
        image={{
          src: "/images/NEP-overview.jpg",
          alt: "Students in classroom",
          caption: "Learning with flexibility & innovation",
        }}
      >
        <p>
          {/* ✅ Keep your original content here */}
          The National Education Policy (NEP) 2020 envisions an India centered education 
          system that contributes directly to transforming our nation sustainably into 
          an equitable and vibrant knowledge society, by providing high-quality education 
          to all. PIET aligns its academic and administrative framework with NEP 2020 
          guidelines to ensure the holistic development of students.
        </p>
      </OverviewSection>
      ...
      <div className="container mx-auto my-10 px-4">
            ...
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 mt-10 mb-20">
                            ...
                            <InfoCard
                                ...
                                content={<Checklist items={iksHighlights} />}
                            />
                            <InfoCard
    ...
    {/*  <section className="py-16 bg-white">
        <div className="container grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <img
              src="https://images.unsplash.com/photo-1588075592446-264a3fbc97df"
              alt="Research and Innovation"
              className="rounded-xl shadow-lg"
            />
          </div>
          <div>
            <h2 className="text-3xl font-bold text-primary mb-6">Our Initiatives</h2>
            <p>
              {/* ✅ Keep your original content here 
              At PIET, we have started implementing several initiatives in line with 
              NEP 2020. This includes curriculum redesign for flexibility, promoting 
              interdisciplinary learning, encouraging research, fostering innovation, 
              and strengthening industry-academia collaboration.
            </p>
          </div>
        </div>
      </section> */}
 ...
 {/* Closing Section with Image */}
      <OverviewSection
        ...
        image={{
          ...
          alt: "Commitment to NEP",
          caption: "Learning with flexibility & innovation",
        }}
      >
        <p>
          {/* ✅ Keep your original content here */}
          PIET is committed to providing an education system that empowers students 
              with the knowledge, skills, values, and mindset to excel in their careers 
              and contribute meaningfully to society. The alignment with NEP 2020 is a 
              step towards making education more inclusive, flexible, and globally relevant.
        </p>
      </OverviewSection>
