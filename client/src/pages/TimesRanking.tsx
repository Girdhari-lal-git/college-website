...
const timesData: TimesDataItem[] = [
    {
        ...
        download: (
            <a href="https://drive.google.com/file/d/1rAyLmNXM8rGz-04o-l3sORzXZq6nz-eS/view?usp=drive_link" download target="_blank" rel="noopener noreferrer">
    ...
    },
    {
        ...
        download: (
            <a href="https://drive.google.com/file/d/1bkU2ZdH8aRMrNkmCXC8D6HBmn65k_YBh/view?usp=drive_link" download target="_blank" rel="noopener noreferrer">
                <button className="bg-primary text-white px-4 py-1 rounded hover:bg-secondary transition inline-flex items-center gap-2">
                    <i className="fas fa-download" /> Download
                </button>
            </a>
    ...
    },
    {
        ...
        download: (
            <a href="https://drive.google.com/file/d/1nfPJ6kijI2FQPu1cEWMiX3DtB5uT90hT/view?usp=drive_link" download target="_blank" rel="noopener noreferrer">
                <button className="bg-primary text-white px-4 py-1 rounded hover:bg-secondary transition inline-flex items-center gap-2">
                    <i className="fas fa-download" /> Download
                </button>
            </a>
