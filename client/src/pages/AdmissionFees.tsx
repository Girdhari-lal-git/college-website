...
const AdmissionFees = () => {
    ...
    const feeStructure = [
        ...
        {
            sno: 4,
            program: "Computer Science & Engineering (Data Science)",
            tuitionFee: "89,857",
            developmentFee: "13,478",
            naacFee: "17,971",
            totalFee: "1,21,306",
        ...
        {
            sno: 5,
            program: "Computer Science & Engineering (Indian Language)",
            tuitionFee: "89,857",
            developmentFee: "13,478",
            naacFee: "17,971",
            totalFee: "1,21,306",
    ...
    const otherFees = [
        ...
        { type: "Data Processing Fee", amount: "Rs 3,250", frequency: "(Annual)" },
        { type: "Miscellaneous Fee", amount: "Rs 9,000", frequency: "(5000 in higher semesters)" },
        {
            type: "Enrollment & Examination Fee ( Estimated )",
            amount: "Rs 6,500",
            frequency: "(5000 in higher semesters)",
        },
    ];
