    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <div className="max-w-8xl mx-auto">
                        <h2 className="text-4xl font-bold text-primary mb-6 text-center">Introduction</h2>
                        <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed text-justify ">
                            <p className="mb-6">
                                Industry-Institute interactions play a pivotal role in shaping the future of engineering 
                                education in India. By fostering collaborations between academic institutions and industry,
                                 these interactions ensure that engineering curricula remain relevant and aligned with 
                                 current industry demands. Through initiatives such as guest lectures by industry experts, 
                                 internships, and joint research projects, students gain valuable hands-on experience and
                                  insights into real-world applications of their studies.
                            </p>
                            <p className="mb-6">
                                These engagements not only enhance the employability of graduates by equipping them with 
                                practical skills but also foster a dynamic learning environment where academic knowledge 
                                is constantly updated to reflect industry trends. Moreover, such collaborations help
                                 institutions stay abreast of technological advancements and industry requirements, 
                                 thereby bridging the gap between theoretical learning and practical application.
                            </p>
                            <p>
                                Ultimately, effective industry-institute interactions contribute to producing a highly
                                 skilled workforce, driving innovation, and strengthening the overall quality of engineering
                                  education in India.
                            </p>
                        </div>
                    </div>
            ...
            <section className="py-16 bg-gray-50">
                <div className="container mx-auto px-4">
                    <h2 className="text-4xl font-bold text-primary mb-8 text-center">Objectives</h2>
                    <div className="max-w-8xl mx-auto">
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <h2 className="text-4xl font-bold text-primary mb-8 text-center">Our Achievements</h2>
