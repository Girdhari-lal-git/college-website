            ...
            <div className="max-w-6xl mx-auto px-4 py-12">
                <section className="max-w-4xl mx-auto">
                    ...
                    <div className="bg-white rounded-lg shadow-xl overflow-hidden">
                        <div className="relative">
                            <LazyImage
                                src="/images/accriditation/AISHE2024-25.jpg"
                        ...
                        <div className="p-6 text-center">
                            ...
                            <p className="text-lg text-neutral-700 leading-relaxed">
                               Poornima Institute of Engineering & Technology proudly holds official registration and recognition 
                               in AISHE 2024–25, the national-level survey conducted by the Ministry of Education, Government of India.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="max-w-4xl mx-auto">
                    ...
                    <div className="bg-white rounded-lg shadow-xl overflow-hidden">
                        <div className="relative">
                            <LazyImage
                                src="/images/accriditation/AISH2023-24.png"
                                alt="AISHE 2023-24 Certificate - Poornima Institute of Engineering & Technology"
                                className="w-full h-auto object-contain bg-gray-50"
                            />
                        </div>
