...
const partnerCategories = {
    ...
    { id: 46, src: "https://www.piet.poornima.org/images/partners/Tech_matrix.jpg", alt: "Tech Matrix", name: "Tech Matrix", type: "Technology Partner", mou: "https://drive.google.com/file/d/117H_xE4jlDke3chATqZGWxulIqQ4I3Jz/view?usp=drive_link" },
    { id: 459, src: "/images/cmp/axiom_logo.png", alt: "Axiom Study", name: "Axiom Study", type: "Technology Partner", mou: "https://drive.google.com/file/d/1APrLkWKrARU0EX1KGhqM6PElc0grnfOk/view?usp=drive_link" },
],
...
internationalUniversities: [
    ...
    { id: 55, src: "/images/cmp/poland_University.jpg", alt: "Jan Wyzykowski University", name: "Jan Wyzykowski University, Poland", type: "Technology Partner", mou: "https://drive.google.com/file/d/1BuxZEkHQOvaL_J1du7VCMqVUWhPvJXbA/view?usp=drive_link" },
     { id: 56, src: "/images/cmp/vcu_logo.png", alt: "Virginia Commonwealth University", name: "Virginia Commonwealth University", type: "Technology Partner", mou: "https://drive.google.com/file/d/1uY3COeQJQP1urFFN_pDyOylj3UXpdv-Z/view?usp=drive_link" },
],

indianAcademicPartners: [
    ...
    { id: 58, src: "/images/cmp/csir_ceeri_logo.png", alt: "CSIR-CEERI", name: "CSIR-CEERI", type: "Technology Partner", mou: "https://drive.google.com/file/d/1Ytg-bUfkXjy0cZXPHb3_2N8VCUfLALiV/view?usp=drive_link" },
],
...
trainingPlacementPartners: [
    ...
    { id: 60, src: "/images/cmp/maxbrain-logo.png", alt: "MaxBrain", name: "MaxBrain", type: "Placement Partner", mou: "https://drive.google.com/file/d/1Di5biSLFun9WruvS5RjlGQyUPdGFpDva/view?usp=drive_link" },
],
...
const stats = [
    ...
    { number: "10+", label: "International Partners", icon: "🌍" },
    ...
    <div className="container mx-auto px-4">
        <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Explore our diverse network of industry leaders, universities,
                academic institutions, publishers, and training partners working
                together to foster innovation, research, skill development, and
        ...
        <CategorySection
            ...
            partners={partnerCategories.industryPartners}
            gradient="bg-gradient-to-r from-blue-600 to-blue-700"
        />

        <CategorySection
            title="International Universities"
            partners={partnerCategories.internationalUniversities}
            gradient="bg-gradient-to-r from-green-600 to-green-700"
        />

        <CategorySection
            title="Indian Institutions & Academic Partners"
            partners={partnerCategories.indianAcademicPartners}
            gradient="bg-gradient-to-r from-teal-600 to-teal-700"
        />

        <CategorySection
            title="Academic & Research Publications"
            partners={partnerCategories.academicResearchPublications}
            gradient="bg-gradient-to-r from-purple-600 to-purple-700"
        />

        <CategorySection
            title="Training & Placement Partners"
            partners={partnerCategories.trainingPlacementPartners}
