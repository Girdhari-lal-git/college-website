          ...
          <div className="lg:col-span-1">
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a href="https://www.facebook.com/PoornimaInstitute/" aria-label="Facebook" className="bg-primary hover:bg-primary-light text-white w-10 h-10 rounded-full flex items-center justify-center transition duration-300">
                  <i className="fab fa-facebook-f"></i>
                </a>
                <a href="https://x.com/piet_jaipur/" aria-label="Twitter" className="bg-primary hover:bg-primary-light text-white w-10 h-10 rounded-full flex items-center justify-center transition duration-300">
                  <i className="fab fa-twitter"></i>
                </a>
                <a href="https://www.instagram.com/piet_jaipur/" aria-label="Instagram" className="bg-primary hover:bg-primary-light text-white w-10 h-10 rounded-full flex items-center justify-center transition duration-300">
                  <i className="fab fa-instagram"></i>
                </a>
                <a href="https://www.linkedin.com/school/poornima-group-of-colleges/posts/?feedView=all" aria-label="LinkedIn" className="bg-primary hover:bg-primary-light text-white w-10 h-10 rounded-full flex items-center justify-center transition duration-300">
                  <i className="fab fa-linkedin-in"></i>
                </a>
                <a href="https://www.youtube.com/@PoornimaUniversityTV" aria-label="YouTube" className="bg-primary hover:bg-primary-light text-white w-10 h-10 rounded-full flex items-center justify-center transition duration-300">
