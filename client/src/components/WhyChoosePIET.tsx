...
const WhyChoosePIET = () => {
  ...
  },
  {
    ...
    title: "Strong Focus on Research & Innovation",
    description: "Encouraging a culture of creativity, problem-solving, and innovation through research-driven projects and initiatives.",
