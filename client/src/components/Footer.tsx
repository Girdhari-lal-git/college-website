...
export default function Footer() {
  ...
  const socialLinks: SocialLinkProps[] = [
    { icon: "fab fa-facebook-f", href: "https://www.facebook.com/PoornimaInstitute/", label: "Facebook" },
    { icon: "fab fa-twitter", href: "https://x.com/piet_jaipur/", label: "Twitter" },
    { icon: "fab fa-instagram", href: "https://www.instagram.com/piet_jaipur/", label: "Instagram" },
    { icon: "fab fa-linkedin-in", href: "https://www.linkedin.com/school/poornima-group-of-colleges/posts/?feedView=all", label: "LinkedIn" },
    { icon: "fab fa-youtube", href: "https://www.youtube.com/@PoornimaUniversityTV", label: "YouTube" },
  ];
  ...
  const programLinks: FooterLinkProps[] = [
    ...
    { href: "/artificial-intelligence", label: "AI & Data Science" },
    { href: "/dep-iot", label: "Internet of Things" },
    ...
    <footer className="bg-primary text-white">
      ...
      <div className="container mx-auto py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Column 3 */}
          <div>
            <h3 className="font-heading font-bold text-xl mb-6">Departments</h3>
            <ul className="space-y-3">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <ContactItem icon="fas fa-phone-alt">+91-9001893262</ContactItem>
      ...
      <div>
            <p className="mb-6 opacity-80 text-center px-8">
